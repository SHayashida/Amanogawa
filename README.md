...
![Star Detection Results](outputs/star_detection_overlay.png)

*Figure: Detected stars (red markers) overlaid on a 30-second smartphone exposure of the Milky Way. This output is automatically generated by the detection pipeline and saved as a PNG for quick quality assessment.*
